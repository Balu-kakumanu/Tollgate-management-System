...
<head>
<title>Admin View-Total Amount Day Wise</title>
...
<script type="text/javascript">
  function validation()
  {
    ...
    if((document.f.day.selectedIndex >= 29) && (document.f.month.selectedIndex == 2))
    {
      alert("February has only 28 days");
      return false;
    }
    if((document.f.day.selectedIndex > 30) && (document.f.month.selectedIndex == 4))
    {
      alert("April has only 30 days");
      return false;
    }
    if((document.f.day.selectedIndex > 30) && (document.f.month.selectedIndex == 6))
    {
      alert("June has only 30 days");
      return false;
    }
    if((document.f.day.selectedIndex > 30) && (document.f.month.selectedIndex == 9))
    {
      alert("September has only 30 days");
      return false;
    }
    if((document.f.day.selectedIndex > 30) && (document.f.month.selectedIndex == 11))
    {
...
<div id="container"> 
  ...
  <div id="development"> 
    ...
    <div style="position:relative; right:5px; top:30px"> 
      <form name="f" method="post" action="total_amtdaily1.jsp" onSubmit="return validation()">
        <table border="0" cellspacing="15">
          ...
          <tr> 
            <td></td>
            <td><br><input type="submit" name="sub" value="Submit"></td>
          </tr>
        </table>
      </form>
    </div>
