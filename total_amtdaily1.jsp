    ...
    <table>
      ...
      <td><table align="center" border="2" bgcolor="#E2E2E2">
          ...
          <tr> 
            ...
            <td><font color="#FF0000">TO DATE</font></td>
...
Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/toll","root","admin");
PreparedStatement ps=con.prepareStatement("select journytype,amount,from_date,to_date,vechile_no,address,type,name from light where from_date='"+newdate+"'");
